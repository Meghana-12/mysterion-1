...
.macro lbox
    /* Unfortunatly, we need r6 as a temporary register */
    push {r6}

    /* Round 1 */
    gf16_mul_lit 0x55555555,0x1c1c1c1c,0x36363636,0x3e3e3e3e
    eor r6, r1, r1, lsl #1 /* accumulate the result for reg[0] */
    eor r6, r6, r1, lsl #2
    eor r6, r6, r1, lsl #3
    eor r6, r6, r1, lsl #4
    eor r6, r6, r1, lsl #5
    eor r6, r6, r1, lsl #6
    eor r6, r6, r1, lsl #7
    and r6, r6, #0x80808080 /* masked addition of first polynomial */
    eor r2, r2, r6
    eor r6, r10, r10, lsl #1 /* accumulate the result for reg[1] */
    eor r6, r6, r10, lsl #2
    eor r6, r6, r10, lsl #3
    eor r6, r6, r10, lsl #4
    eor r6, r6, r10, lsl #5
    ...
    and r6, r6, #0x80808080 /* masked addition of first polynomial */
    eor r3, r3, r6
    eor r6, r11, r11, lsl #1 /* accumulate the result for reg[2] */
    eor r6, r6, r11, lsl #2
    eor r6, r6, r11, lsl #3
    eor r6, r6, r11, lsl #4
    eor r6, r6, r11, lsl #5
    ...
    and r6, r6, #0x80808080 /* masked addition of first polynomial */
    eor r4, r4, r6
    eor r6, r12, r12, lsl #1 /* accumulate the result for reg[3] */
    eor r6, r6, r12, lsl #2
    eor r6, r6, r12, lsl #3
    eor r6, r6, r12, lsl #4
    eor r6, r6, r12, lsl #5
    ...
    eor r6, r6, r1, lsl #6
    eor r6, r6, r1, asr #1
    and r6, r6, #0x40404040 /* masked addition of first polynomial */
    eor r2, r2, r6
    eor r6, r10, r10, lsl #1 /* accumulate the result for reg[1] */
    eor r6, r6, r10, lsl #2
    eor r6, r6, r10, lsl #3
    ...
    eor r6, r6, r1, asr #1
    eor r6, r6, r1, asr #2
    and r6, r6, #0x20202020 /* masked addition of first polynomial */
    eor r2, r2, r6
    eor r6, r10, r10, lsl #1 /* accumulate the result for reg[1] */
    eor r6, r6, r10, lsl #2
    eor r6, r6, r10, lsl #3
    ...
    eor r6, r6, r1, asr #2
    eor r6, r6, r1, asr #3
    and r6, r6, #0x10101010 /* masked addition of first polynomial */
    eor r2, r2, r6
    eor r6, r10, r10, lsl #1 /* accumulate the result for reg[1] */
    eor r6, r6, r10, lsl #2
    eor r6, r6, r10, lsl #3
    ...
    eor r6, r6, r1, asr #3
    eor r6, r6, r1, asr #4
    and r6, r6, #0x8080808 /* masked addition of first polynomial */
    eor r2, r2, r6
    eor r6, r10, r10, lsl #1 /* accumulate the result for reg[1] */
    eor r6, r6, r10, lsl #2
    eor r6, r6, r10, lsl #3
    ...
    eor r6, r6, r1, asr #4
    eor r6, r6, r1, asr #5
    and r6, r6, #0x04040404 /* masked addition of first polynomial */
    eor r2, r2, r6
    eor r6, r10, r10, lsl #1 /* accumulate the result for reg[1] */
    eor r6, r6, r10, lsl #2
    eor r6, r6, r10, asr #1
    ...
    eor r6, r6, r1, asr #5
    eor r6, r6, r1, asr #6
    and r6, r6, #0x02020202 /* masked addition of first polynomial */
    eor r2, r2, r6
    eor r6, r10, r10, lsl #1 /* accumulate the result for reg[1] */
    eor r6, r6, r10, asr #1
    eor r6, r6, r10, asr #2
    ...
    eor r6, r1, r1, asr #1 /* accumulate the result for reg[0] */
    eor r6, r6, r1, asr #2
    eor r6, r6, r1, asr #3
    eor r6, r6, r1, asr #4
    eor r6, r6, r1, asr #5
    eor r6, r6, r1, asr #6
    eor r6, r6, r1, asr #7
    and r6, r6, #0x01010101 /* masked addition of first polynomial */
    eor r2, r2, r6
    eor r6, r10, r10, asr #1 /* accumulate the result for reg[1] */
    eor r6, r6, r10, asr #2
    eor r6, r6, r10, asr #3
    eor r6, r6, r10, asr #4
    eor r6, r6, r10, asr #5
    ...
    and r6, r6, #0x01010101 /* masked addition of first polynomial */
    eor r3, r3, r6
    eor r6, r11, r11, asr #1 /* accumulate the result for reg[2] */
    eor r6, r6, r11, asr #2
    eor r6, r6, r11, asr #3
    eor r6, r6, r11, asr #4
    eor r6, r6, r11, asr #5
    ...
    and r6, r6, #0x01010101 /* masked addition of first polynomial */
    eor r4, r4, r6
    eor r6, r12, r12, asr #1 /* accumulate the result for reg[3] */
    eor r6, r6, r12, asr #2
    eor r6, r6, r12, asr #3
    eor r6, r6, r12, asr #4
    eor r6, r6, r12, asr #5
    ...
    /* restore r6 back from the stack */
    pop {r6}
.endm
